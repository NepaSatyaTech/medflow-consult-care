    ...
    <footer className="bg-gray-50 pt-16 pb-8">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-xl text-medflow-blue mb-4">MedFlow</h3>
            <p className="text-gray-600 mb-4">Your trusted partner in healthcare, combining pharmacy services with doctor consultations.</p>
            <div className="flex space-x-4">
              <a href="#" className="text-medflow-blue hover:text-medflow-blue-dark">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-600 hover:text-medflow-blue transition-colors">
